...
class ListDokumenKelembagaanAnjab extends Component
{
    ...
    #[Title('Dokumen Kelembagaan Anjab')]
    ...
    {
        return Document::where('tipe_doc', 'kelembagaan_anjab')
            ->select('year')
            ->distinct()
    ...
    public function store()
    {
        ...
        $noUrutan = Document::where('tipe_doc', 'kelembagaan_anjab')->count() + 1;
    ...
    {
        $documents = Document::where('tipe_doc', 'kelembagaan_anjab')
        ...
        return view('livewire.admin.dokumen.list-dokumen-kelembagaan-anjab', [
            'documents' => $documents,
        ]);
    }
}
