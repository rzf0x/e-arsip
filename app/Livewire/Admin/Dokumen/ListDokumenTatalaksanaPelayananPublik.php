...
class ListDokumenTatalaksanaPelayananPublik extends Component
{
    use WithPagination;
    use WithFileUploads;
    ...
    #[Title('Dokumen Tatalaksana Pelayanan Publik')]
    ...
    {
        return Document::where('tipe_doc', 'tatalaksana_pelayanan_publik')
            ->select('year')
            ->distinct()
    ...
    public function store()
    {
        ...
        $noUrutan = Document::where('tipe_doc', 'tatalaksana_pelayanan_publik')->count() + 1;
    ...
    {
        $documents = Document::where('tipe_doc', 'tatalaksana_pelayanan_publik')
        ...
        return view('livewire.admin.dokumen.list-dokumen-tatalaksana-pelayanan-publik', [
            'documents' => $documents,
        ]);
    }
}
