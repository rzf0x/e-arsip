...
class ListDokumenDataInovasiPelayananPublik extends Component
{
    use WithPagination;
    use WithFileUploads;
    ...
    {
        return Document::where('tipe_doc', 'inovasi_pelayanan_publik')
            ->select('year')
            ->distinct()
    ...
    public function store()
    {
        ...
        $noUrutan = Document::where('tipe_doc', 'inovasi_pelayanan_publik')->count() + 1;
    ...
    {
        $documents = Document::where('tipe_doc', 'inovasi_pelayanan_publik')
        ...
        return view('livewire.admin.dokumen.list-dokumen-data-inovasi-pelayanan-publik', [
            'documents' => $documents,
        ]);
    }
}
