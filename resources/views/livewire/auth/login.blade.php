<div id="auth-left">
    ...
    <h1 class="auth-title text-center">
        SIKARBO
        <span class="text-center fs-2 text-capitalize d-block">Sistem Informasi kumpulan arsip bagian organisasi</span>
    </h1>

    <p class="auth-subtitle fs-5">
        Login menggunakan email & password!
    </p>

    <form wire:submit="login">
        <div class="form-group position-relative has-icon-left mb-4">
            <input wire:model.live.debounce.300ms="email" type="text" class="form-control form-control-xl"
                placeholder="Email">
